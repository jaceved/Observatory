         ...
         <div class="w-container">
            <div class="w-form">
               <form class="form1" id="email-form" name="form" data-name="form" >
                   ...
                   <a href="home.jsp"><input class="w-button but" value="Return Home" data-wait="Please wait..."></a>
                   <a href="request.jsp.html"><input class="w-button but" value="New Proposal" data-wait="Please wait..."></a>
