...
<body>
    ...
    <div class="w-section section hero">
        ...
        <div class="w-section section grey" id="features">
                ...
                <form id ="deleteTempUserForm" action="adminupdates.jsp" method="POST">

                    <input type="radio" style="display:none;" id="deleteTempUser" name="deleteTempUser" value="deleteTempUser" checked >
                    ...
                    <table border="4" class ="table">
                        <tbody>
                            ...
                            <tr bgcolor = "#FF9999">   
                                ...
                                <td><input type="checkbox" name="dropTempUsers" value="<%out.write(emails[index]);%>"> Delete user  </td>                                                                  
                ...
                <div id="currentUsersContainer">
                    <fieldset>
                    <h2>Current Users:</h2>
                    <form id ="deleteUserForm" action="adminupdates.jsp" method="POST">

                        <input type="radio" style="display:none;" id="deleteUser" name="deleteUser" value="deleteUser" checked >
                        ...
                        <table border="4" class ="table">
                            <tbody>
                                ...
                                %>
                                <tr>
                                    <%out.print("There are no users in the system");%> 
                                </tr>
                                <%
                                    dbManager.closeCxn();
                                ...
                                %>
                                <tr bgcolor = "#99FF99">
                                    <td><input type="checkbox" name="dropUsers" value="<%out.write(emails[index]);%>"> Delete user <br></td>
                                   <td><%out.print(section);%> </td>
