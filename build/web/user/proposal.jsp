...
<%
  ...
  // User is not logged in.
    ...
    if(session.getAttribute("schedulingPermission") != "yes")
    {
        //user does not have permission, so throw them back to their home
        session.setAttribute("nopermission", "nopermission");
    ...
    <body>
        ...
        <div class="w-section section grey" id="features">
            <div class="requestblock">
                <div class="w-form">
                    <form class="w-clearfix requestform" action="../processors/processRequest.jsp" method="POST">
